...
- Hold styling API: `setHeldState({ ids, held, scale = 1.08, color = '#3aa0ff' })` tints dice (strong blue overlay on instanced meshes) and bumps their scale for the given roll or die ids.
